	...
	<div class="device-list-container">
		...
		<div class="device-list-content">
			<a-form-model class="table-search-form" layout="inline" :model="searchForm">
				...
				<a-form-model-item>
					<a-select v-model="searchForm.deviceTypeId" :options="deviceTypeOptions" />
				</a-form-model-item>
				<a-form-model-item>
					<a-select v-model="searchForm.deviceModelId" :options="deviceIdOptions" />
				</a-form-model-item>
				<a-form-model-item>
				...
				<div class="other-btns">
					<a-button type="primary" @click="add"><a-icon type="plus" />新增设备</a-button>
