const setupMonitorApis = http => ({
	...
	monitorAllAlarmType: () => http.get("/api-alarm/statistics/monitor/alarmTypeByUser", {}),
	...
	groupDetailDevicePeriod: groupId => http.get("/api-device/monitor/group/statisticsDevicePeriod", { groupId }),
})
